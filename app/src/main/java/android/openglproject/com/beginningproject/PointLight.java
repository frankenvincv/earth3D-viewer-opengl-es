...
public class PointLight
{
	...
	private float m_specular_shininess = 1.8f;

	private Vector3 m_Position;
	
	public PointLight(Context context)
	{
		m_light_ambient[0] = 0.2f;
		m_light_ambient[1] = 0.2f;
		m_light_ambient[2] = 0.2f;
			
		m_light_diffuse[0]	=	0.5f;
		m_light_diffuse[1]	=	0.5f;
		m_light_diffuse[2]	=	0.5f;
